...
namespace Lab5.Services
{
    ...
    {
        private readonly string booksFilePath = "./Data/Books.csv";
        private readonly string usersFilePath = "./Data/Users.csv";
...
/* 
 * Most of this was created by Buchanan besides AddBookWithoutChangingId, as that was created so when books are readded to Books.csv,
 * it adds the correct ID for said book.
*/